...
## What I Do:
- Build **robust** that power seamless experiences.  
- Work with my **team in the background**, ensuring things just work.  
- Focus on **scalability, performance, and clean architecture**.  
- Passionate about **automation, DevOps, and backend problem-solving**.
- Open for **exciting collaborations** and **innovative projects**.

## My Tech Stack:
<img src="https://skillicons.dev/icons?i=nodejs,express,python,django,kotlin,java,go,cs,cpp,mongodb,mysql,postgres,redis,docker,kubernetes,nginx,git,aws,firebase&theme=light&perline=8" alt="Tech Stack" />
...
## Support & Follow ❤️:
- ☕ **[Patreon](https://www.patreon.com/nayandas69)** – Support for love.
- 🎥 **[YouTube](https://www.youtube.com/@dasnayan69)** – Tutorials, Games & more!  
   Or Scan the QR code below to subscribe:    
   <img src="img/YT_QR.jpg" alt="Subscribe on YouTube" width="150" height="150">
   <img src="img/YT_QR0.jpg" alt="Subscribe on YouTube" width="150" height="150">
